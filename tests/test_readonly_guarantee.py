"""La garantía: el auditor NUNCA escribe en el tenant."""
import pathlib
import re

APP = pathlib.Path(__file__).resolve().parent.parent / "auditor"
...
def test_el_cliente_graph_no_expone_escritura():
    from auditor import graph
